...
#./ATMGiroAsistido/Business Services/ATMGiroAsitido.bix:	<tran:provider-id>http</tran:provider-id>
#./BCO_CL_TUX_FM_SolicitudRescateRegistrar-v1_0_IMPL/BusinessServices/LogFMSolicitudRescateRegistrar.bix:      <env:value>file:///u01/apli/bea103/AppLog</env:value>
#./BCO_CL_TUX_FM_ValidarFechaContableObtener-v1_0_IMPL/BusinessServices/BS_CL_TUX_FMValFechConObt.bix:      <env:value>tuxedo:OSBFMValFechConObt/FMValFechConObt</env:value>


echo "procesando business ...."
find . -name '*.bix' -exec grep -iH '<env:value>' {} \; > endpoints.txt
...
sed -i 's/____________//g'  endpoints.txt
echo ""
echo ""
